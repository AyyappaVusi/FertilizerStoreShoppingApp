class GalleryController < ApplicationController
  ...
  def search
    ...
    @search_results= Store.find_by_sql ["Select * from stores WHERE name like ? or fertilizer_type like ? or price like ? or nutrient_value like ?",keyword,keyword,keyword,keyword]
  end
end
